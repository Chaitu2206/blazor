...
namespace Zindagi.Domain.RequestsAggregate.QueryHandlers
{
    public class SearchBloodRequestHandler : IRequestHandler<SearchBloodRequest, List<BloodRequestSearchRecordDto>>
    {
        ...
        public async Task<List<BloodRequestSearchRecordDto>> Handle(SearchBloodRequest request, CancellationToken cancellationToken) => await _repository.GetSearchResultsAsync(request.SearchQuery);
    }
}
